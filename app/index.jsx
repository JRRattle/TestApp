...
import { setUid, getUid, getGlobalEmail, setGlobalEmail } from '../app/profileDet';
  ...
  const handleSignIn = async () => { 
    try {
      ...
      await signInWithEmailAndPassword(auth, email, password)
        //.then((userCredential) => {
          // Signed in
          //userCredential is the result of signInWithEmailAndPassword 
          //const user = userCredential.user;
          //setting global variable uid
         // setUid(user.uid);
  ...
  const handleSignUp = async () => {
    try {
      await createUserWithEmailAndPassword(auth, email, password)
       ...
       // console.log("what was captured from setEmail(user.Email): ",getGlobalEmail());
       // console.log("what was captured from setUid(user.uid): ",getUid());
      // })
        setError('');
        router.push("/home");
    } catch (err) {
