...
import { View, Button, LogBox, StyleSheet, Text, Pressable } from "react-native";
...
//const backendUrl = "rome--graphite-prism-441920-m0.us-central1.hosted.app";
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable 
        ...
        <Text>Go to about pressable</Text>
        </Pressable>
    </View>
  );
};
